...
const FAQ_ITEMS: FAQItem[] = [
  ...
  {
    question: "Q. 4회기 이후 추가 2회기를 제공받는 기준이 어떻게 되나요?",
    answer: [
      "기본 4회 상담 후 사후 검사 결과가 정상 범위(0~4점)에 해당하지 않으면 추가 2회기를 지원합니다.",
      "점수가 개선되었더라도 5점 이상이면 지원 대상입니다.",
      "단, 사업 운영 상황에 따라 예고 없이 중단될 수 있습니다.",
    ],
  },
  {
    question: "Q. 경기도 소재 기업 재직자 참여기준이 어떻게 되나요?",
    answer: [
      ...
      <div className="page-shell">
        ...
        <div className="mx-auto max-w-[1000px]">
          ...
          <div className="mt-10 text-center text-[16px] leading-6 text-text-sub md:mt-14 md:text-[16px] md:leading-7">
            ...
            <p className="mt-1">이메일 : <a href="mailto:help@dallem.com">help@dallem.com</a></p>
          </div>
        </div>
